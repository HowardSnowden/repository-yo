...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { by: @version.by, description: @version.description, document: @version.document, version: @version.version }
    end
  ...
  test "should update version" do
    patch :update, id: @version, version: { by: @version.by, description: @version.description, document: @version.document, version: @version.version }
    assert_redirected_to version_path(assigns(:version))
  end
